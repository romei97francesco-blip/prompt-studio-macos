...
swiftc -module-cache-path "$module_cache" -parse-as-library PromptStudio.swift OpenRouter.swift -o '../Prompt Studio.app/Contents/MacOS/PromptStudio' -framework SwiftUI -framework AppKit
